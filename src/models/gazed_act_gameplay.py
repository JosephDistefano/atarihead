...
from models.selective_gaze_only import SGAZED_ACTION_SL

# from models.action_sl import ACTION_SL
...
def test_seas_model(config, game):
    ...
    if game == "phoenix":
        dataset_val = [
            "606_RZ_5215078_Aug-07-16-59-46",
            "600_RZ_5203429_Aug-07-13-44-39",
            "598_RZ_5120717_Aug-06-14-53-30",
            "574_RZ_4682055_Aug-01-12-54-58",
            "565_RZ_4604537_Jul-31-15-22-57",
            "550_RZ_4513408_Jul-30-14-04-09",
        ...
        dataset_val = [
            "543_RZ_4430054_Jul-29-14-54-56",
            "246_RZ_721092_Feb-20-21-52-26",
            "260_RZ_1456515_Mar-01-10-10-36",
            "534_RZ_4166872_Jul-26-13-49-43",
            "553_RZ_4519853_Jul-30-15-51-37",
        ]
        env_name = "Asterix-v0"

    elif game == "breakout":
        dataset_val = [
            "564_RZ_4602455_Jul-31-14-48-16",
        ...
        dataset_val = [
            "267_RZ_2956617_Mar-18-19-52-47",
            "576_RZ_4685615_Aug-01-13-54-21",
        ]
        env_name = "NameThisGame-v0"

    elif game == "space_invaders":
        dataset_val = [
            "554_RZ_4520643_Jul-30-16-08-32",
            "511_RZ_3988011_Jul-24-12-07-48",
            "512_RZ_3991738_Jul-24-13-12-15",
            "514_RZ_3993948_Jul-24-13-47-04",
            "541_RZ_4427259_Jul-29-14-08-29",
            "587_RZ_4775423_Aug-02-14-51-06",
    ...
    for i_episode in range(start_episode, end_episode, 1):
        ...
        while True:
            ...
            gaze_true = (gaze_true - np.min(gaze_true)) / (
                np.max(gaze_true) - np.min(gaze_true)
            )

            gaze_true = np.array(
                cv2.resize(gaze_true, (160, 210)) * 255, dtype=np.uint8
            )
            ...
            observation, reward, teriminated, truncated, info = env.step(action)

            done = truncated or teriminated
